---
name: Voquill repository agent instructions (AGENTS.md)
description: >-
  Provider-published AGENTS.md from github.com/voquill/voquill, saved
  verbatim below the marker line. Operating instructions for AI coding
  agents working in the open-source Voquill monorepo (Tauri desktop app,
  enterprise gateway, admin dashboard, Flutter mobile app, marketing site).
api: none (Voquill publishes no public developer API)
method: searched
generated: 2026-07-21
source: https://github.com/voquill/voquill/blob/main/AGENTS.md
operations: []
---

<!-- verbatim copy of https://github.com/voquill/voquill/blob/main/AGENTS.md follows -->
